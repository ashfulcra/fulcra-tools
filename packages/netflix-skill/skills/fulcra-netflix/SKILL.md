...
>
> One thing to know up front, so you can decide with eyes open: at the end I'll invite you to share your data with the pool owner (Fulcra ID `a24a9667-c2c6-4bbf-9a0f-36ea0afcb521`). Fulcra's sharing page currently shares **all of your annotation data, not just the Netflix history** — it has no way to share only one kind of annotation yet. If that's more than you're comfortable with, you can simply skip the share and still keep your imported history for yourself. Nothing gets shared unless you do it yourself, in your own browser, at the end.
>
> Here's the plan:
