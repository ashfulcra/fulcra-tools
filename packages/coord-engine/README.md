...
with their user's other agents: coordinate work, discover what's new on every loop. A
**stdlib-only** Python CLI that gives a fleet of independent agents (Claude Code, Codex,
