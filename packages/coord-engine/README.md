...
| Directives & messaging | `tell` · `broadcast` · `remind` · `respond` · `later` (backlog) · `intent` (spoken commitment) · `listen` (retired as the wake surface 2026-07-27; kept for reference until removal) |
