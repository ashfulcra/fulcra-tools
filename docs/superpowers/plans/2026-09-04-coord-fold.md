# coord-fold: Coord on Annotations Implementation Plan (r25)
...
def attested_status(exe, team, slug, pin):
    ...
    environment cannot substitute the process that reports on it."""
