...
```json
{
  ...
  "chrome_identity": "ash@fulcradynamics.com", // Google account in this Chrome
...
authors = [{name = "ash", email = "ash@fulcradynamics.com"}]
dependencies = [
    "click>=8.1",
    "httpx>=0.27",
    "fulcra-api>=0.5",
