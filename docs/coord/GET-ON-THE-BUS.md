...
uv tool install "git+https://github.com/ashfulcra/fulcra-tools@coord-engine-v2.0.5#subdirectory=packages/coord-engine"
```
...
uv tool install --force \
  "git+https://github.com/ashfulcra/fulcra-tools@coord-engine-v2.0.5#subdirectory=packages/coord-engine" \
...
0. **The permission classifier may refuse the installs themselves.** Some
   ...
   git clone --depth 1 --branch coord-engine-v2.0.5 https://github.com/ashfulcra/fulcra-tools /tmp/ft
...
The `coord-engine-v2.0.5` tag is the cold-install release. The fleet runtime
