...
uv tool install "git+https://github.com/ashfulcra/fulcra-tools@coord-engine-v1.7.1#subdirectory=packages/coord-engine"
```
...
uv tool install --force \
  "git+https://github.com/ashfulcra/fulcra-tools@coord-engine-v1.7.1#subdirectory=packages/coord-engine" \
...
0. **The permission classifier may refuse the installs themselves.** Some
   ...
   git clone --depth 1 --branch coord-engine-v1.7.1 https://github.com/ashfulcra/fulcra-tools /tmp/ft
